...
public class vehicleBean {
    ...
    public List<vehicleBean> getVehicles() {
        ...
        String sql = "SELECT * FROM automobile.VEHICLES";
    ...
    public void rentVehicle(int vehicleID) {
        ...
        String sql = "SELECT * FROM automobile.VEHICLES WHERE VEHICLE_ID = ?";

        //Set chosen vehicle's availability to false
        String sql2 = "UPDATE automobile.VEHICLES SET availability = 'false' WHERE VEHICLE_ID = ?";

        //Add a rent log to the rent table
        String sql3 = "INSERT INTO automobile.RENTS (vehicle_id, date, username) values (?, ?, ?)";
